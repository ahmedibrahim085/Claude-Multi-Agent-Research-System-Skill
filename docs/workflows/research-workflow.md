...
## Multi-Agent Research with Mandatory Synthesis Delegation

This workflow documents the mandatory orchestration pattern for research tasks, including trigger keywords, workflow steps, and architectural constraints that enforce proper delegation.
